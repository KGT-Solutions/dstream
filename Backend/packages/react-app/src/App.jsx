...
const initialNetwork = NETWORKS.zkEVM; // <------- select your target frontend network (localhost, goerli, xdai, mainnet)
...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "RollVideo", "purpose", [], localProviderPollingTime);
